 ...
 * `import devDump from 'claude-lemon/<version>/parser.dev.json'`.
 */
...
//
//   import { parse } from 'claude-lemon/sqlite-${version}';
//   parse('SELECT 1');
//
...
/**
 * Cross-version re-export shim.  `import 'claude-lemon'` resolves to
