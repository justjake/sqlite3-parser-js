...
//                                     `import 'sqlite3-parser'` resolves
//                                     to by default.
//
// Usage:
 ...
 * inspecting rule actionC source — can import them directly via
 * `import devDump from 'sqlite3-parser/<version>/parser.dev.json'`.
 */
...
//
//   import { parse } from 'sqlite3-parser/sqlite-${version}';
//   parse('SELECT 1');
//
...
/**
 * Cross-version re-export shim.  `import 'sqlite3-parser'` resolves to
 * this file (see package.json's `main`), which re-exports whatever
 * version is marked current in the manifest.  Regenerated whenever the
 * vendor flow lands a new version.
 */
